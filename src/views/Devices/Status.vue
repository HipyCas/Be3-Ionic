<template>
    <ion-page>
        <ion-content>
            ...
            <FullPageText v-else title="Start by adding a device!" text="Go to devices/list and click the add floating button"></FullPageText>
        </ion-content>
    </ion-page>            
</template>
...
export default {
    name: 'DevicesStatus',
    components: { IonPage, IonContent, IonCard, IonCardHeader, IonItem, IonIcon, IonCardTitle, IonNote, IonCardContent, IonList, IonListHeader, IonBadge, FullPageText },
    computed: {
        devices () {
